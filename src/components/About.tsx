    ...
    <div className="about-section" id="about">
      <div className="about-me">
        ...
        <p className="para">
          ...
          and UI design for app and web products in Figma. Comfortable owning projects end-to-end from concept to client-ready delivery while collaborating closely with marketing, product,
